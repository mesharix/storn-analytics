...
export default function AIChatWidget() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: "Hi! I'm your AI assistant. I can help you with data analysis or answer any questions you have. How can I help you today?",
      timestamp: new Date(),
    },
  ]);
        ...
        <div className="fixed bottom-6 right-6 z-50 w-[400px] h-[600px] bg-slate-900 rounded-2xl shadow-2xl flex flex-col border border-indigo-500/30 overflow-hidden">
          ...
          <div className="p-4 bg-slate-900 border-t border-slate-700">
            ...
            <p className="text-xs text-slate-500 mt-2 text-center">
              Press Enter to send • Powered by GLM-4.6
            </p>
          </div>
        </div>
      )}
